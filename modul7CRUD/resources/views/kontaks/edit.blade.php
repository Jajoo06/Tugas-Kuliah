            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('kontaks.update', $kontak->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" value="{{ $kontak->nama }}"
                            required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="no_hp" name="no_hp"
                            value="{{ $kontak->no_hp }}" required>
                    </div>
                    <button type="submit" class="btn btnprimary">Update</button>
                    <a href="{{ route('kontaks.index') }}" class="btn btnsecondary">Batal</a>
                </form>
            </div>
        </div>
    </div>
