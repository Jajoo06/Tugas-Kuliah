        ...
        <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <form action="{{ route('upload.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="file" name="file" id="file" class="mt-2 px-3 py-2 border border-gray-300 rounded-md shadow-sm w-full focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
